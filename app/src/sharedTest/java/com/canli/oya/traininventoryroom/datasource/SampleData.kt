...
val sampleTrain1 = Train(trainName = "Red Wagon", categoryName = sampleCategory1.categoryName, brandName = sampleBrand1.brandName, modelReference = "MN", description = "In very good state", quantity = 1, scale = "1.2", location = "2-A")
val sampleTrain2 = Train(trainName = "Blue Loco", categoryName = sampleCategory2.categoryName, brandName = sampleBrand2.brandName)
val sampleTrain3 = Train(trainName = "Orange TGV", categoryName = sampleCategory1.categoryName, brandName = sampleBrand1.brandName)
